function [STATE,totalImpinge,impinge,s,beta] = calcCollectionEfficiency(airfoil,fluid,strImpMod)
...
xL = -0.5; Yhit = -0.1;
Ymiss = 0.3;
yLimUP = impingementLimitsSLD(fluid,airfoil,xL,Ymiss,Yhit,'UP');
Ymiss = -0.3;
yLimDOWN = impingementLimitsSLD(fluid,airfoil,xL,Ymiss,Yhit,'DOWN');
