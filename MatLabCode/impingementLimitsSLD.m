function yL = impingementLimitsSLD(fluid,airfoil,xL,Ymiss,Yhit,limstr)
% FUNCTION: determine impingement limits on airfoil surface given a
% specified flow field
% INPUTS: fluid, airfoil, xL, Ymiss, Yhit, limstr
...
x = fluid.x; y = fluid.y; rhol = fluid.rhol; Rd = fluid.Rd;
Unew = ug + 0.01*ug*unifrnd(-1,1);
Vnew = vg + 0.01*vg*unifrnd(-1,1);
cloud = SLDcloud([Xnew Ynew Unew Vnew Rd 0 1],rhol,1);
