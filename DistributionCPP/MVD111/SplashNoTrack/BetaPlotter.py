...
xyExp = genfromtxt("BetaMVD111Experiment.dat", delimiter = ',');
xyLEWICE = genfromtxt("BetaMVD111LEWICE.dat", delimiter = ',');
xyDROP3D = genfromtxt("BetaMVD111DROP3D.dat", delimiter = ',');
...
plt.plot(xInterp+0.01,yInterp,lw=4);
plt.plot(-xyExp[:,0],xyExp[:,1],c='r',lw=4);
